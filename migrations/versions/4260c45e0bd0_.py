...
def upgrade():
    ...
    op.add_column('order', sa.Column('amount', sa.Numeric(precision=8, scale=2, decimal_return_scale=2), nullable=False))
    op.add_column('user', sa.Column('mobile_phone', sa.String(length=16), nullable=False))
    op.add_column('user', sa.Column('qq_number', sa.String(length=16), nullable=True))
